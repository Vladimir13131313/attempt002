...
export const DownBar = ({quantity, storeId, setContentList, openMoveModal, closeDownBar}) => {
    ...
    function parseProductList() {
        let listOfProducts = JSON.parse(localStorage.getItem(warehouses))[storeId].products;
        let listOfLists = [];
        if (listOfProducts) {
        ...
        <div className="down_bar" id="down_bar">
            <div className="down_bar_content">
                ...
                <div className="buttons">
                    ...
                    <button className="common_button move_button" id="move_button" onClick={() => openMoveModal()}>
                        Move&nbsp;&nbsp;&nbsp;&nbsp;
